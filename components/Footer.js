      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-muted leading-relaxed max-w-xs">
              ...
              elegance — crafted exclusively for him and her.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-border-subtle flex items-center justify-center text-muted hover:text-gold hover:border-gold/40 transition-all duration-300"
                >
                  <svg
                    width="18"
                    height="18"
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm text-muted">
              <li className="flex items-start gap-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 text-crimson flex-shrink-0">
        ...
        <div className="pt-8 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted">
            © {currentYear} Trimmy&apos;s Luxurious Salon. All rights reserved.
          </p>
          <p className="text-xs text-muted">
            Crafted with{" "}
            <span className="text-crimson">♥</span> in Bhiwadi
          </p>
        </div>
      </div>
    </footer>
